...
module User::PasswordReset
  ...
  class_methods do
    def find_with_password_reset_id(id)
  ...
  def reset_password
    update!(password_reset_token: self.class.generate_unique_secure_token)
  ...
  def password_reset_id
    message_verifier.generate(
      { user_id: id, password_reset_token: password_reset_token },
      purpose: :password_reset,
      expires_in: 2.hours
    )
  end
